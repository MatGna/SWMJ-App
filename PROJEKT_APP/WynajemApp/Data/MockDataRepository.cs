...
public class MockDataRepository : IDataRepository
{
    ...
    // Akcje operacyjne nie sa wspierane przez mock - aplikacja powinna w tym
    // trybie pokazac komunikat ze potrzebna jest baza.
    public void Doladuj(int idUzytkownika, decimal kwota)
        => throw new NotSupportedException("Tryb mockowy - przelacz na SQL Server (appsettings.json: UseMockRepository=false).");
